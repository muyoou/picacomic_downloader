...
delIcon=PhotoImage(file=".\\icon\\delete.gif")
...
Button(toolBar,text="取消下载",borderwidth=0,activeforeground="LightCoral",padx=5,height=10,command=event.cancelSelected,image=cancerIcon,compound=LEFT).pack(side=LEFT)
#Button(toolBar,text="删除",borderwidth=0,activeforeground="LightCoral",padx=5,height=10,command=event.downloadSelected,image=delIcon,compound=LEFT).pack(side=LEFT)
...
downloadNum.set("选中漫画后，点击[下载]开始下载")
